...
namespace Binarysharp.MSharp
{
    ...
    public class MemorySharp : IDisposable, IEquatable<MemorySharp>
    {
        ...
        {
            ArgumentNullException.ThrowIfNull(Modules.MainModule);
        ...
        /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
        public void Write<T>(IntPtr address, [DisallowNull] T value, bool isRelative = true)
        {
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
        public void Write<T>(Enum address, [DisallowNull] T value, bool isRelative = true)
        {
        ...
        /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
        public void Write<T>(IntPtr address, T[] array, bool isRelative = true) where T : notnull
        {
        ...
        /// <param name="array">The array to write.</param>
        /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
        public void Write<T>(Enum address, T[] array, bool isRelative = true) where T : notnull
        {
