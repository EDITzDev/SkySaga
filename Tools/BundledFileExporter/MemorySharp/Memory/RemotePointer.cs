...
namespace Binarysharp.MSharp.Memory
{
    ...
    public class RemotePointer : IEquatable<RemotePointer>
    {
        ...
        public void Write<T>(int offset, [DisallowNull] T value)
        {
        ...
        /// <param name="offset">The offset where the value is written from the pointer.</param>
        /// <param name="value">The value to write.</param>
        public void Write<T>(Enum offset, [DisallowNull] T value)
        {
        ...
        /// <typeparam name="T">The type of the value.</typeparam>
        /// <param name="value">The value to write.</param>
        public void Write<T>([DisallowNull] T value)
        {
            Write(0, value);
        }
        /// <summary>
        ...
        public void Write<T>(int offset, T[] array) where T : notnull
        {
        ...
        /// <param name="offset">The offset where the values is written from the pointer.</param>
        /// <param name="array">The array to write.</param>
        public void Write<T>(Enum offset, T[] array) where T : notnull
        {
        ...
        /// <typeparam name="T">The type of the values.</typeparam>
        /// <param name="array">The array to write.</param>
        public void Write<T>(T[] array) where T : notnull
        {
            Write(0, array);
        }
        #endregion
